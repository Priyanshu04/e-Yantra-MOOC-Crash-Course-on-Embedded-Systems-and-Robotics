/*! \mainpage Section-4 Experiment-2: Speed Control using 8 bit Phase Correct PWM Mode
 *
...
void timer_pwm_init(void) {
	...
	// Configure for Phase Correct PWM, 8-bit mode
	TCCR5A_reg |= (1 << WGM0_bit);
	TCCR5A_reg &= ~(1 << WGM1_bit);
	TCCR5B_reg &= ~((1 << WGM3_bit) | (1 << WGM2_bit));
